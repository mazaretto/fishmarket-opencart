		...
		if ($product_info) {
            ...
            if ($product_info['image']) {
                $data['images'][] = array(
                    ...
                    'thumb' => $this->model_tool_image->resize($product_info['image'], '375', '300'),
                    'mini'  => $this->model_tool_image->resize($product_info['image'], '80', '90')
                );
            }
			...
			foreach ($results as $result) {
				$data['images'][] = array(
					...
					'thumb' => $this->model_tool_image->resize($result['image'], '375', '300'),
                    'mini'  => $this->model_tool_image->resize($result['image'], '80', '90'),
                );
			}
